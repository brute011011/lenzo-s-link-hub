...
export const ServiceCard = ({ name, url, description, status, latencyMs }: ServiceCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="ios-liquid-glass group p-6 relative"
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2.5">
            <div className="flex items-center gap-1.5 text-xs text-muted-foreground font-mono bg-muted/50 rounded-full px-2.5 py-1">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 pill-btn bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-primary/80 active:scale-[0.98]"
