  ...
  return (
    <div className="min-h-screen relative selection:bg-[#007AFF]/20">
      ...
      <div className="fixed top-8 right-8 z-50">
        <Link to="/login">
          <LiquidGlassCard className="px-6 py-3 flex items-center gap-2" style={{ borderRadius: '999px' }}>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-24 space-y-20">
        <header className="text-center space-y-6 pt-12">
          ...
          <p className="text-[#86868B] text-xl md:text-2xl font-medium tracking-tight max-w-2xl mx-auto">
            Elite infrastructure for high-performance automation.
          </p>
        </header>
